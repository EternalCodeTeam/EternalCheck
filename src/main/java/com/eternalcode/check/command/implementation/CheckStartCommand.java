...
public class CheckStartCommand {
    ...
    public CheckStartCommand(CheckedUserDataConfig checkedUserDataConfig, CheckedUserService checkedUserService, NotificationAnnoucer annoucer, ConfigManager configManager, MessagesConfig messages, EventCaller eventCaller, PluginConfig config) {
    ...
    void execute(Player player, @Arg @Name("player") Player playerArgument) {
        ...
        this.annoucer.annouceMessage(player, this.messages.check.admin.start, formatter);

        for (Notification notification : this.messages.check.startMessages) {
            this.annoucer.annouceMessage(playerArgument, notification, formatter);
        }
